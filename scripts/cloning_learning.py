...
class Net(chainer.Chain):
	def __init__(self, n_channel=3, n_action=1):
		...
		super(Net, self).__init__(
			...
			fc8=L.Linear(512, n_action, initialW=np.zeros((n_action, 512), dtype=np.int32))
			)
...
class clong_learning:
	...
	def save(self, save_path):
		        chainer.serializers.save_npz('/home/masaya/models/d0.5_4000.net' , self.net)
